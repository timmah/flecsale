...
namespace detail {
  constexpr input_traits::arr_d_r_t length = {1.2,1.2};
  constexpr input_traits::arr_d_s_t num_cells = {20,20};
}
...
inline ristra::hard_coded_source_ptr_t base_problem_2d() {
  ...
  reg<arrayr_t> const arrayr_reg = {{"xmin", {0.0,0.0}},
                                      {"xmax", detail::length}};
